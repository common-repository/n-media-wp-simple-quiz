...
jQuery(function($){
    ...
    $('.input_check').click(function(e) {
        ...
        if( wqt_vars.multiple_answers === 'multiple_ans' ) {
            ...
            if( checked_answers > max_ans_allowed ) {
                ...
                Swal.fire({title: '<span class="swt-title">Max '+max_ans_allowed+ ' Answers Allowed</span>' , confirmButtonColor: '#217ac8'});
                return ;
            }
    ...
    $("#mcqs-front-quizz").submit(function(e){
        ...
        $.post(wqt_vars.ajax_url, data, function(data){
            ...
            const confirm = Swal.fire({title:data, icon: "success", confirmButtonColor: '#217ac8'})
            .then((result) => {
