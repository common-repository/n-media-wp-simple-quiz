...
class WQT_Admin {
    ...
    function wqt_add_scripts($hook) {
       ...
       if ( $post->post_type == 'wqt' ||  $post->post_type == 'wqt_result') {
           ...
           wp_enqueue_style('wqt-bootstrap', WQT_URL."/css/bootstrap/bootstrap.min.css");


           // ====== style file load =============
           // wp_enqueue_style('wqt-admin-style', WQT_URL."/css/wqt-admin.css");
           wp_enqueue_style('wqt-awsm-font', WQT_URL."/css/font-awesome/css/font-awesome.css");
           wp_enqueue_style('wqt-swlt', WQT_URL."/css/sweetalert/sweetalert.css");
           ...
           wp_enqueue_script('wqt-bootstrap-js', WQT_URL."/css/bootstrap/bootstrap.min.js", array('jquery'), WQT_VERSION, true);
           ...
           wp_enqueue_script('wqt-swlt', WQT_URL."/css/sweetalert/sweetalert.js", array('jquery'), WQT_VERSION, true);
        }
    }
