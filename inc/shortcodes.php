...
function wqt_shortcodes_render_frontend($attr){
    ...
    if ($curent_user_role == true) {
        ...
        wp_enqueue_style('wqt-sweetalert-style', WQT_URL."/css/sweetalert/sweetalert.css");
            
        // js files load
        wp_enqueue_script('wqt-sweetalert-js', WQT_URL."/css/sweetalert/sweetalert.js", array('jquery'), '1.0', true);
