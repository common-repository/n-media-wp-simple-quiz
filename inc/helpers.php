<?php 
    ...
    // sanitize_deep_array
    function wqt_front_sanitize_data($data) {
        $sanitized_data = array();
        foreach ($data as $key => $value) {
            if (is_array($value)) {
                $sanitized_data[$key] = wqt_front_sanitize_data($value);
            } else {
    ...
    function wqt_update_value_result_cpt($wqt_result_date , $username ,$email, $time_taken, $single_time, $quiz_id, $submit_quiz_meta){
    ...
    function wqt_result_table_display( $wqt_result_id ){
        ...
        echo wp_kses_post($sumbit_result);
    }
