...
<div class="wqt_wrapper">
    <div class="wqt-print-page-body">
        ...
        <span><?php echo 'Q'.esc_html($question_no++).':'; ?></span>
        <label><?php echo esc_html($the_question); ?></label></br>
                    
        <span><?php echo esc_html($selected_ans_strng); ?></span>
            <?php  foreach ($ans_meta_data as $index => $options) {
         
 ?>

        <span><?php echo esc_html($variable++).')'; ?></span>
        
        <span><?php echo esc_html($options['answer']); ?></span></br>
