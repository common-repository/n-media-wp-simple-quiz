...
<div class="card register_card register_hide" style="background: <?php echo esc_attr($bg_color);?>;" >
	<div class="form-body register_form">
		<div class="wqt-form-msg" style="background: <?php echo esc_attr($header_clr);?>;" >
