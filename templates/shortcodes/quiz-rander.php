...
/* ===== Frontend quiz form template ====== */
    ...
    $header_clr 	= $quizz_setting->get_option('wqt_question_header_color', '#49d1e2c4');
    
    $bg_color   	= $quizz_setting->get_option('wqt_background_color', '#b6bd710d') ;
    
	$btn_clr        = $quizz_setting->get_option('wqt_button_clr', '#72dbe7');


	$btn_text_clr   = $quizz_setting->get_option('wqt_button_text_clr', 'white');

    $quiz_font_size = $quizz_setting->get_option('wqt_question_label_size', '20px');
    ...
    $wqt_quiz_message       = $quizz_setting->get_option('wqt_quiz_message', 'You are Done!');

    $quiz_form_width        = $quizz_setting->get_option('wqt_quiz_form_width', '100%');

    $selected_option_clr    = $quizz_setting->get_option('wqt_selected_option_clr', 'white');

    $wqt_instruction_quiz   = $quizz_setting->get_option('wqt_instruction_quiz', "Lets' Start");
...
<div class="wqt_wrapper container-fluid wqt-quiz-render">
    <div class="wqt-quiz-design" style="width:<?php echo $quiz_form_width; ?>">
